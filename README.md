...
_example_: 'python3 orca6-batch-create.py -i orca6.inp -s run-sbatch-batchJcouplings-mahti -g geometrylist-full.xyz -n 29'
...
_Remember to 'chmod u+x submit-singleton.sh' to make it executable._
